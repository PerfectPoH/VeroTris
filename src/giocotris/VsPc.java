 ...
 * @author Niccolo'
 */
public class VsPc extends javax.swing.JFrame {

    /**
     * Creates new form VsPc
     */
    public VsPc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VsPc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
